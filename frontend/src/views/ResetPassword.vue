...
const handleResetPassword = async () => {
  ...
  if (password.value !== confirmPassword.value) {
    showNotification("error", "Reset unsuccessful", "Passwords do not match.");
      ...
      <div class="reset-password-content">
        ...
        <template v-else>
          <template v-if="tokenValid">
            ...
            <p class="intro">
              Create a new password for your StockWell account.
            </p>
          ...
          <div v-else class="invalid-state">
            <div class="invalid-icon" aria-hidden="true">!</div>
...
.reset-password-page :deep(.page-gradient) {
  opacity: 0.9;
...
.reset-password-page :deep(.background-orb) {
  opacity: 0.52;
...
.reset-password-page :deep(.orb-gold),
.reset-password-page :deep(.orb-orange),
.reset-password-page :deep(.orb-purple),
.reset-password-page :deep(.orb-lavender) {
  transform: scale(0.9);
}

.reset-password-page :deep(.orb-gold) {
  animation-name: resetOrbGold;
}

.reset-password-page :deep(.orb-orange) {
  animation-name: resetOrbOrange;
}

.reset-password-page :deep(.orb-purple) {
  animation-name: resetOrbPurple;
}

.reset-password-page :deep(.orb-lavender) {
  animation-name: resetOrbLavender;
}

@keyframes resetOrbGold {
  0%,
  100% {
  ...
  50% {
    transform: translate(72px, 48px) scale(1.06);
  }
}

@keyframes resetOrbOrange {
  0%,
  100% {
    transform: translate(0, 0) scale(0.9);
  }
  ...
  50% {
    transform: translate(-72px, 64px) scale(1.04);
  }
}

@keyframes resetOrbPurple {
  0%,
  100% {
  ...
  50% {
    transform: translate(44px, -56px) scale(1.02);
  }
}

@keyframes resetOrbLavender {
  0%,
  100% {
    transform: translate(0, 0) scale(0.9);
  }
  ...
  50% {
    transform: translate(-40px, -48px) scale(1.02);
  }
}
